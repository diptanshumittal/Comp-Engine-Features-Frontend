        ...
        <div className="container">
            ...
            <ul className="list">
                <li>
                    ...
                    . This research began in 2008, led by <a target="_blank" href="https://www.imperial.ac.uk/people/nick.jones">Nick Jones</a>
                    , and is currently led by Ben Fulcher at the <a target="_blank" href="https://dynamicsandneuralsystems.github.io">Neural Systems and Signals Group</a>
                ...
                <li>
                    ...
                    <div className="contact-box">
                        <ul>
                            <li><a target="_blank" rel="noreferrer" href="https://mail.google.com/mail/?view=cm&fs=1&to=physics.compengine@sydney.edu.au"><i className="fa fa-envelope"></i></a><p>Mail us on</p></li>
                            ...
                            <li><a target="_blank" rel="noreferrer" href="https://twitter.com/compTimeSeries"><i className="fa fa-twitter"/></a><p>Follow us on</p></li>
                        </ul>
                    </div>

                ...
                <div className="section" style={{display:"block"}}>
                    ...
                    <ul className="list">
                        <li><strong>CompEngine: Time-Series Features</strong> is based on active research on a
                            ...
                            It is a companion website to <a href="https://www.comp-engine.org" target="_blank">CompEngine: Time Series</a> ,
                            which is focused on time-series data. The research underlying these projects is
                            currently led by Ben Fulcher at the <a href="https://dynamicsandneuralsystems.github.io" target="_blank">Neural Systems and Signals Group</a>.
                            <br/>Our aims are as follows:</li>
                            <ul>
                                <li>To assist the selection of appropriate methods for data by allowing researchers working with time-series analysis
                        ...
                        <li>The features included in <strong>CompEngine: Time-Series Features</strong> are from the <a href="https://github.com/benfulcher/hctsa" target="_blank">hctsa</a> time-series
                            ...
                            <ul>
                                <li>B.D. Fulcher and N.S. Jones. <a href="https://www.cell.com/cell-systems/fulltext/S2405-4712(17)30438-6" target="_blank"><i>hctsa</i>: A computational framework for automated time-series phenotyping using massive feature extraction</a>. <i>Cell Systems</i> <strong>5</strong>, 527 (2017).</li>
                                <li>B.D. Fulcher, M.A. Little, N.S. Jones. <a href="https://royalsocietypublishing.org/doi/full/10.1098/rsif.2013.0048" target="_blank">Highly comparative time-series analysis: the empirical structure of time series and their methods</a>. <i>J. Roy. Soc. Interface</i> <strong>10</strong>, 83 (2013).</li>
                            </ul>
                        </li>
                        <li>To understand the behavior of a given time-series feature, we apply it to 1000 diverse time series
                            , from the <a href="https://figshare.com/articles/dataset/1000_Empirical_Time_series/5436136" target="_blank">Empirical1000</a> collection of data
                            , which is a subset of the <a href="https://figshare.com/articles/dataset/1000_Empirical_Time_series/5436136" target="_blank">CompEngine Time Series</a> library.
                            <br/>To learn more about the data, read our open paper:
                            <ul>
                                <li>B.D. Fulcher et al. <a href="https://doi.org/10.1038/s41597-020-0553-0" target="_blank">A self-organizing, living library of time-series data</a>. <i>Scientific Data</i> <strong>7</strong>, 213 (2020).</li>
                            </ul>
                        </li>
                    </ul>
                </div>
                ...
                <div className="section" style={{display:"block"}}>
                    ...
                    <ul className="list">
                        ...
                        <li>On <strong>CompEngine: Time Series Features</strong>
                            ...
                            , and understand how they behave on time-series data, using a range of tabular and quantitative statistics and interactive visualizations
                            . You can also upload your own analysis function to see how it behaves relative to existing methods
                            . You can take your analysis further by downloading the results, or running tailored analyses (such as comparing performance on a specific dataset (a
                            n example of how analyses can be performed in Matlab is <a href="https://github.com/benfulcher/CandidateFeatureLab" target="_blank">here</a>.
                        </li>
                    </ul>
                </div>
